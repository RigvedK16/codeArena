    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden flex flex-col">
            ...
            <div
                ...
                className="flex overflow-auto flex-1"
                style={{ minHeight: "20rem", maxHeight: "28rem" }}
            >
                {/* Line Numbers - scrolls vertically */}
                <div
                    ref={lineNumbersRef}
                    className="shrink-0 w-12 bg-gray-800 text-gray-500 text-xs py-4 px-2 text-right select-none border-r border-gray-700 overflow-y-auto"
                >
                    {sourceCode.split("\n").map((_, i) => (
                ...
                <div className="flex-1 min-w-0 overflow-auto">
                    <Editor
                        ...
                        padding={16}
                        className="font-mono text-sm text-gray-100 min-h-full"
                        style={{
